...
class WhatsAppManager:
    ...
    def _focus_whatsapp_window(self) -> bool:
        ...
        try:
            if is_windows():
                ...
                run_command('osascript -e "tell application \"WhatsApp\" to activate"')
                return True
    ...
    async def send_message_desktop(self, contact: str, message: str, language: str = 'en', confirmed: bool = False) -> Dict:
    ...
    async def make_call(self, contact: str, call_type: str = 'voice', language: str = 'en') -> Dict:
        """Make WhatsApp call"""
        try:
