...
class FileManager:
    ...
    async def list_files(self, folder_name: str = None, pattern: str = "*", language: str = "en") -> Dict:
        ...
        try:
            ...
            return {"success": False, "action_type": "LIST_FILES", "error": str(e), "response": "Failed to list files"}
    ...
    async def copy_file(self, source: str, destination: str, language: str = "en") -> Dict:
        ...
        try:
            ...
            return {"success": False, "action_type": "COPY_FILE", "error": str(e), "response": "Failed to copy file"}
    ...
    async def move_file(self, source: str, destination: str, language: str = "en") -> Dict:
        ...
        try:
            ...
            return {"success": False, "action_type": "MOVE_FILE", "error": str(e), "response": "Failed to move file"}
