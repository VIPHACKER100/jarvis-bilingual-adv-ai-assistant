...
class InputController:
    ...
    async def get_cursor_position(self) -> Dict:
        ...
        try:
            ...
            return {"success": False, "action_type": "GET_CURSOR", "error": str(e)}
    ...
    async def move_cursor(self, x: int, y: int, duration: float = 0.5) -> Dict:
        ...
        try:
            ...
            return {"success": True, "action_type": "MOVE_CURSOR", "position": {"x": x, "y": y}}

        except Exception as e:
            logger.error(f"Error moving cursor: {e}")
            return {"success": False, "action_type": "MOVE_CURSOR", "error": str(e)}
    ...
    async def move_cursor_relative(self, dx: int, dy: int) -> Dict:
        ...
        try:
            ...
            return {"success": False, "action_type": "MOVE_CURSOR_RELATIVE", "error": str(e)}
    ...
    async def click(self, button: str = "left", clicks: int = 1) -> Dict:
        ...
        try:
            ...
            return {"success": True, "action_type": "MOUSE_CLICK", "button": button, "clicks": clicks}

        except Exception as e:
            logger.error(f"Error clicking: {e}")
            return {"success": False, "action_type": "MOUSE_CLICK", "error": str(e)}
    ...
    async def double_click(self) -> Dict:
        ...
        try:
            ...
            return {"success": True, "action_type": "DOUBLE_CLICK"}

        except Exception as e:
            logger.error(f"Error double clicking: {e}")
            return {"success": False, "action_type": "DOUBLE_CLICK", "error": str(e)}
    ...
    async def scroll(self, amount: int, direction: str = "vertical") -> Dict:
        ...
        try:
            ...
            return {"success": True, "action_type": "SCROLL", "amount": amount, "direction": direction}

        except Exception as e:
            logger.error(f"Error scrolling: {e}")
            return {"success": False, "action_type": "SCROLL", "error": str(e)}

    async def drag(self, start_x: int, start_y: int, end_x: int, end_y: int, duration: float = 1.0) -> Dict:
        ...
        try:
            ...
            return {"success": False, "action_type": "DRAG", "error": str(e)}

    async def type_text(self, text: str, interval: Optional[float] = None) -> Dict:
        """Type text with human-like speed"""
        try:
            if interval is None:
                interval = random.uniform(0.03, 0.08)  # 30-80ms between characters
            ...
            return {"success": True, "action_type": "TYPE_TEXT", "text_length": len(text)}

        except Exception as e:
            logger.error(f"Error typing text: {e}")
            return {"success": False, "action_type": "TYPE_TEXT", "error": str(e)}
    ...
    async def press_key(self, key: str) -> Dict:
        ...
        try:
            ...
            return {"success": True, "action_type": "PRESS_KEY", "key": key_lower}

        except Exception as e:
            logger.error(f"Error pressing key: {e}")
            return {"success": False, "action_type": "PRESS_KEY", "error": str(e)}

    async def press_hotkey(self, keys: List[str]) -> Dict:
        """Press multiple keys simultaneously (hotkey)"""
        try:
            if len(keys) < 2:
                return {"success": False, "action_type": "PRESS_HOTKEY", "error": "Hotkey requires at least 2 keys"}
            ...
            return {"success": True, "action_type": "PRESS_HOTKEY", "keys": normalized_keys}

        except Exception as e:
            logger.error(f"Error pressing hotkey: {e}")
            return {"success": False, "action_type": "PRESS_HOTKEY", "error": str(e)}
    ...
    async def take_screenshot_region(self, x: int, y: int, width: int, height: int) -> Dict:
        ...
        try:
            ...
            return {"success": False, "action_type": "SCREENSHOT_REGION", "error": str(e)}
