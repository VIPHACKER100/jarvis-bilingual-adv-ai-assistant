...
class MediaProcessor:
    ...
    async def extract_text_from_pdf(
        self, pdf_path: str, page_number: Optional[int] = None, language: str = "en"
    ) -> Dict:
        ...
        try:
            ...
            def convert_pdf():
                return convert_from_path(str(path), first_page=page_number, last_page=page_number)
    ...
    def categorize_ocr_text(self, text: str) -> Dict[str, Any]:
        ...
        return {"category": best_cat, "confidence": confidence, "scores": scores}
    ...
    async def analyze_screen(self, query: Optional[str] = None, language: str = "en") -> Dict:
        ...
        try:
            ...
            prompt = (
                query
                or "Describe what is on my screen right now. Be specific about open windows, text, and any visible UI elements."
            )
            if language == "hi":
                prompt = (
                    query or "बताएं कि अभी मेरी स्क्रीन पर क्या है। खुले हुए विंडोज़, टेक्स्ट और यूआई एलिमेंट्स के बारे में विस्तार से बताएं।"
                )
            ...
            try:
                ...
                return {"success": False, "action_type": "VISION_ANALYSIS", "error": str(ve), "response": str(ve)}
    ...
    async def merge_pdfs(self, pdf_files: List[str], output_path: str, language: str = "en") -> Dict:
        ...
        try:
            ...
            return {"success": False, "action_type": "PDF_MERGE", "error": str(e), "response": "Failed to merge PDFs"}
    ...
    async def split_pdf(self, pdf_path: str, pages: List[int], output_path: str, language: str = "en") -> Dict:
        ...
        try:
            ...
            return {"success": False, "action_type": "PDF_SPLIT", "error": str(e), "response": "Failed to split PDF"}

    async def pdf_to_images(
        self, pdf_path: str, output_folder: Optional[str] = None, dpi: int = 200, language: str = "en"
    ) -> Dict:
    ...
    async def convert_image(
        self, input_path: str, output_path: str, format: Optional[str] = None, language: str = "en"
    ) -> Dict:
    ...
    async def batch_images_to_pdf(
        self, source_folder: str, output_name: str = "batch_images.pdf", language: str = "en"
    ) -> Dict:
    ...
    async def draw_shape(self, shape: str = "circle", language: str = "en") -> Dict:
        ...
        try:
            ...
            return {"success": True, "action_type": "DRAW_SHAPE", "shape": shape, "response": f"Drew a {shape}"}
        except Exception as e:
            return {"success": False, "error": str(e)}
