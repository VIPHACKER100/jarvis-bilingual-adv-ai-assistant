...
HINDI_COMMANDS = {
    ...
    "ocr_image": [
        ...
        "photo padho",
        "padh ke batao",
        "इमेज से टेक्स्ट निकालो",
        "फोटो से टेक्स्ट निकालो",
        "टेक्स्ट निकालो",
    ],
    "ocr_pdf": [
    ...
    "pdf_to_images": [
        ...
        "pdf ko image \nbanao",
        "pdf image me badlo",
        "pdf ko images mein convert karo",
        "पीडीएफ को इमेज में बदलो",
    ],
    "images_to_pdf": [
        "images to pdf",
        "images ko pdf \nmein convert karo",
        "photo se pdf banao",
        "इमेज को पीडीएफ में बदलो",
    ],
    # Phase 3: Desktop
    "take_screenshot": [
        "take screenshot",
    ...
    "empty_recycle_bin": [
        "empty recycle bin",
        "recycle bin khali karo",
        "trash saaf karo",
        "kachra saaf karo",
        "delete sab kuch",
        "रीसायकल बिन खाली करो",
        "रिसाइकिल बिन खाली करो",
        "कूड़ा साफ करो",
        "कचरा साफ करो",
    ],
    "toggle_taskbar": [
    ...
    "batch_pdf": [
        "batch images to pdf",
        "sare photo pdf banao",
        "folder pdf banao",
        "batch pdf",
        "sabka pdf banao",
        "सारी फोटो पीडीएफ बनाओ",
        "फोल्डर पीडीएफ बनाओ",
        "सभी इमेज की पीडीएफ बनाओ",
    ],
    "scan_folder": [
        "scan folder",
        "folder scan karo",
        "file dhoondo folder mein",
        "folder dekho",
        "फोल्डर स्कैन करो",
        "फोल्डर में ढूंढो",
    ],
    ...
    "get_selected_text": [
        "get selected text",
        "select kiya hua text",
        "selected text padho",
        "text copy karo selection se",
        "kya select kiya",
        "सेलेक्ट किया हुआ टेक्स्ट",
        "चुना हुआ टेक्स्ट पढ़ो",
        "सेलेक्टेड टेक्स्ट",
    ],
    # Search & Browser
    "google_search": [
