    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
      ...
      >
        ...
        <div className='glass-panel rounded-lg p-3 mb-4'>
          <p className='font-mono text-sm text-slate-200 break-words'>
            {command}
          </p>
          ...
          <div className='relative w-16 h-16'>
            <svg className='w-16 h-16 -rotate-90' viewBox='0 0 64 64'>
              ...
              <circle
                ...
                fill='none'
                stroke={
                  timedOut ? '#ff3355' : remaining <= 10 ? '#ffaa00' : '#00d4ff'
                }
                strokeWidth='4'
        ...
        {timedOut ? (
          <p className='text-center text-sm text-neon-error font-semibold mb-4'>
