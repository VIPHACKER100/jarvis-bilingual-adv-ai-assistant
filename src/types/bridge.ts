...
export interface WebSocketMessage {
  type: 'command_result' | 'system_status' | 'confirmation_request' | 'error' | 'pong' | 'notification' | 'macro_update' | 'proactive_suggestion' | 'wake_detected' | 'agent_thinking' | 'agent_resolved';
