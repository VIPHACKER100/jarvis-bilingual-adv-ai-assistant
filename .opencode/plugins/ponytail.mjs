...
const { getPonytailInstructions } = require('../../.opencode/hooks/ponytail-instructions');
const { getDefaultMode, normalizePersistedMode } = require('../../.opencode/hooks/ponytail-config');
